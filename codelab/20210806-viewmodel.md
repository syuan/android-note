...
- rotation config 처럼 configuration change 가 발생했을때 onCreate 부타 다시 시작하면서 상태를 잃어버리게 되는데, ViewModel 의 lifecycle 이 더 길고 (ViewModelStore 에 저장되는듯?) 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTY5ODY1MzhdfQ==
-->