...
내부적으로는 위의 ExecutorService 사용함, 초기에는 매우큰 thread pool 을 사용하는 executor 의 동작만 제공하였으나, 버전이 올라가면서 pool 크기를 줄이고 single executor 를 사
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5NTkyMDk0MiwxNTI5OTYwNzAzLDE1MT
