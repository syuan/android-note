...
- HandlerThread 는 안드로이드에서 제공되는 클래스로 기본 worker thread 는 looper 가 비어 있는 상태로 만들어지는데, HandlerThread 는 worker thread 사용의 편의를 위하여 looper 와 handler 를 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDk4MjM5NDcsMTUyOTk2MDcwMywxNT
